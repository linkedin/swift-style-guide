...
* **1.14** Properties should be ordered following logical order; in order to have a good readibility we want to group them in three main sets representing the visibility scope:
1. public
2. internal
3. private
...
```swift
// PREFERRED
public var variable1: ... // 10 or more elements in this group, keep them alphabetically ordered
public var variable2: ...
public var variable3: ...
public var variable4: ...
public var variable5: ...
public var variable6: ...
public var variable7: ...
public var variable8: ...
public var variable9: ...
public var variable10: ...

internal var ...: ... // less than 10 elements in this group, keep them logically ordered
var name: String
var surname: String
var ...: ...
var fullName: String { // keep computed properties at the end of the group
    return name + surname
}

private var age: Int?
private var spinner: UIActivityIndicatorView? { return ... } // keep computed properties at the end of the group
...
public var variable9: ...
public var variable6: ...
public var variable10: ... // not  preferring alphabetical order

internal var ...: ...
var name: String
var surname: String
private var ...: ... // private properties should be grouped
var fullName: String { // computed properties should be at the end of the group
    return name + surname
}
var ...: ...

private var spinner: UIActivityIndicatorView? { return ... } // computed properties should be at the end of the group
private var age: Int?
